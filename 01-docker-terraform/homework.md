...
**Note:**
Read `deployment.md` and run `load_data.ipynb`
...
where DATE(t.lpep_pickup_datetime) = '2019-09-18' and DATE(t.lpep_dropoff_datetime) = '2019-09-18' 
```
...
```sql
select z."Borough" , SUM(t."total_amount") total_amount
from green_taxi_data t
...
```bash
(de) ubuntu@vml-mle-nic:~/projects/de_zoomcamp/01-docker-terraform$ terraform apply
...
Terraform will perform the following actions:
  ...
  + resource "google_bigquery_dataset" "demo_dataset" {
      ...
      + dataset_id                 = "demo_dataset_20240128"
...
google_bigquery_dataset.demo_dataset: Creation complete after 0s [id=projects/vld-dtc-de-00001/datasets/demo_dataset_20240128]
google_storage_bucket.demo-bucket: Creation complete after 1s [id=vld_bucket_test_20240128]
```